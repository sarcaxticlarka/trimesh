      ...
      >
        ...
        <div className="lg:w-1/2 relative overflow-hidden group">
          ...
          <div className="absolute bottom-16 left-16 z-20">
             <h2 className="text-5xl font-bold text-white mb-4 tracking-tighter">Elevate your<br/>3D workflow.</h2>
             <p className="text-zinc-300 text-lg max-w-sm font-medium">Join the world's most advanced 3D marketplace for professional creators.</p>
          </div>
        </div>
        ...
        <div className="lg:w-1/2 p-10 sm:p-20 flex flex-col justify-center bg-black/40">
          <div className="mb-12">
            <h1 className="text-5xl font-bold text-gradient mb-4 auth-reveal">Sign In.</h1>
            <p className="text-zinc-400 auth-reveal text-lg">Enter your details to access your studio.</p>
          </div>
          ...
          <p className="mt-12 text-center text-zinc-500 auth-reveal">
            New to TriMesh?{' '}
            <Link href="/signup" className="text-white font-bold hover:text-violet-400 transition-colors">
              Create an account
            </Link>
          </p>
        </div>
